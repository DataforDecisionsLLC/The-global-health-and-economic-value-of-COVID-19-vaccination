...
capture log close
log using "$output\IHME\make_quarterly_deaths_&_infections_China", text replace
...
compress 
save "$output\IHME\quarterly_deaths_&_infections_Hong_Kong_China_Macoa", replace

////////////////////////////////////////////////////////////////////////////////
////////// sum the Hong Kong and Macao infections, deaths and vax data /////////
////////////////////////////////////////////////////////////////////////////////

use "$output\IHME\quarterly_deaths_&_infections_Hong_Kong_China_Macoa", clear
drop if country=="China"

collapse (sum) daily_deaths inf_mean, by(year quarter yyyy_qq)

gen country="Hong Kong + Macao"
order  country 
isid year quarter

save "$output\IHME\quarterly_deaths_&_infections_Hong_Kong_plus_Macoa", replace
...
use          "$output\IHME\quarterly_deaths_&_infections_Hong_Kong_China_Macoa", clear 
append using "$output\IHME\quarterly_deaths_&_infections_Hong_Kong_plus_Macoa"
...
compress 
save "$output\IHME\quarterly_deaths_&_infections_China", replace
