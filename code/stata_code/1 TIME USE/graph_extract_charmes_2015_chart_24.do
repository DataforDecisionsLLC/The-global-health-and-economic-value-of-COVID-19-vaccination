...
capture log close
log using "$raw\TIME USE\CHARMES\Processed\graph_extract_charmes_2015_chart_24", text replace

////////////////////////////////////////////////////////////////////////////////
//// Process data points extracted using DigitizeIt: Charmes 2015-Chart 24 /////
...
import excel using ///
"$raw\TIME USE\CHARMES\DigitizeIt\Charmes 2015-Chart 24 paid_work.xlsx", ///
...
save "$raw\TIME USE\CHARMES\Processed\Charmes 2015-Chart 24 paid_work", replace

///////////////////////////////// unpaid work //////////////////////////////////

import excel using ///
"$raw\TIME USE\CHARMES\DigitizeIt\Charmes 2015-Chart 24 unpaid_work.xlsx", ///
clear sheet("Data") first case(lower)
...
save "$raw\TIME USE\CHARMES\Processed\Charmes 2015-Chart 24 unpaid_work", replace

/////////////////////////////// leisure ////////////////////////////////////////

import excel using ///
"$raw\TIME USE\CHARMES\DigitizeIt\Charmes 2015-Chart 24 leisure.xlsx", ///
clear sheet("Data") first case(lower)
...
save "$raw\TIME USE\CHARMES\Processed\Charmes 2015-Chart 24 leisure", replace

//////////////////////////// personal care /////////////////////////////////////

import excel using ///
"$raw\TIME USE\CHARMES\DigitizeIt\Charmes 2015-Chart 24 pc.xlsx", ///
clear sheet("Data") first case(lower)
...
save "$raw\TIME USE\CHARMES\Processed\Charmes 2015-Chart 24 pc", replace

/////////////////////////////////// other //////////////////////////////////////

import excel using ///
"$raw\TIME USE\CHARMES\DigitizeIt\Charmes 2015-Chart 24 other.xlsx", ///
clear sheet("Data") first case(lower)
...
save "$raw\TIME USE\CHARMES\Processed\Charmes 2015-Chart 24 other", replace

////////////////////////////// combine /////////////////////////////////////////

use                     "$raw\TIME USE\CHARMES\Processed\Charmes 2015-Chart 24 paid_work", clear 
merge 1:1 country using "$raw\TIME USE\CHARMES\Processed\Charmes 2015-Chart 24 unpaid_work"
assert _m==3 
drop _m
merge 1:1 country using "$raw\TIME USE\CHARMES\Processed\Charmes 2015-Chart 24 leisure"
assert _m==3 
drop _m 
merge 1:1 country using "$raw\TIME USE\CHARMES\Processed\Charmes 2015-Chart 24 pc"
assert _m==3 
drop _m 
merge 1:1 country using "$raw\TIME USE\CHARMES\Processed\Charmes 2015-Chart 24 other"
assert _m==3 
drop _m 
...
compress 
save "$raw\TIME USE\CHARMES\Processed\Charmes 2015-Chart 24", replace
