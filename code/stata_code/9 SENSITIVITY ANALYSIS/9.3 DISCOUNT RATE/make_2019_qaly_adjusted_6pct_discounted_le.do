...
capture log close
log using "$output\QALY\make_2019_qaly_adjusted_6pct_discounted_le", text replace
...
clear 
capture erase "$output\QALY\2019_qaly_adj_6pct_discounted_le" 
save          "$output\QALY\2019_qaly_adj_6pct_discounted_le", emptyok replace 
...
append using "$output\QALY\2019_qaly_adj_6pct_discounted_le" 
sort country year age 
save "$output\QALY\2019_qaly_adj_6pct_discounted_le" , replace 
