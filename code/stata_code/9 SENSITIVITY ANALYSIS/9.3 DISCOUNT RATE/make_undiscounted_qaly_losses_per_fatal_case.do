...
capture log close
log using "$output\QALY\make_undiscounted_qaly_losses_per_fatal_case", text replace

////////////////////////////////////////////////////////////////////////////////
// aggregate the qaly-adjusted undiscounted life expectancy to the age groups //
...
save "$output\QALY\wtd_baseline_undiscounted_qaly", replace 
...
merge m:1 country age_group using "$output\QALY\wtd_baseline_undiscounted_qaly"
drop if country=="Djibouti"
assert _m==3 
drop _m 
sort country year quarter age_group 
...
save "$output\QALY\undiscounted_qaly_losses_per_fatal_case", replace 
