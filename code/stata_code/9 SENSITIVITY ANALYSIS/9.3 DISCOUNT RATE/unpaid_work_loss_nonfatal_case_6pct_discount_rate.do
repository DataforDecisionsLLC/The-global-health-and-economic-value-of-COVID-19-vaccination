...
capture log close
log using "$output\ECONOMIC DATA\INDIRECT COSTS\unpaid_work_loss_nonfatal_case_6pct_discount_rate", text replace
...
compress 
save "$output\ECONOMIC DATA\INDIRECT COSTS\unpaid_work_loss_nonfatal_case_6pct_discount_rate", replace
...
using "$output\ECONOMIC DATA\INDIRECT COSTS\unpaid_work_loss_nonfatal_case_6pct_discount_rate"
assert _m==3 
drop _m 
sort country year quarter
