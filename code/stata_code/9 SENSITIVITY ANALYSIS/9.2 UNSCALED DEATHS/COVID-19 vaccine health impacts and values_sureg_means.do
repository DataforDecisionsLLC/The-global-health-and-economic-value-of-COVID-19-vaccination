...
gl root   "C:\DFD-LIFESCIENCES\PFIZER COVID\DB Work\"
gl output "$root\DATA"
//cd        "$root"

/*
gl root   "C:\Users\dburnes\OneDrive - Data For Decisions\Desktop\PROPOSALS\COVID19\"
gl output "$root\DATA"
cd        "$root"
*/
...
use "$root\REGRESSION RESULTS\SENSITIVITY ANALYSIS\ONE-WAY\UNSCALED DEATHS\no_cont_2_lags_death_pfizer_v_other_overall", clear 
...
compress 
save "$root\REGRESSION RESULTS\SENSITIVITY ANALYSIS\ONE-WAY\UNSCALED DEATHS\value_of_vax_costs", replace
...
append using  "$root\REGRESSION RESULTS\SENSITIVITY ANALYSIS\ONE-WAY\UNSCALED DEATHS\value_of_vax_costs"
...
merge 1:1 country yyyy_qq year quarter brand using ///
"$root\REGRESSION RESULTS\SENSITIVITY ANALYSIS\ONE-WAY\UNSCALED DEATHS\value_of_vax_costs"
assert _m!=1
drop _m 
