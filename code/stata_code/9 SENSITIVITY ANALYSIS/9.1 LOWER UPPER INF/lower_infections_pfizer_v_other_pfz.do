...
merge 1:1 country_group time using "$root\REGRESSION RESULTS\SUR\LOWER UPPER INF\sim_0_novax_inf_pfz_lower"
drop if _m==2
...
save "$root\REGRESSION RESULTS\SUR\LOWER UPPER INF\lower_infections_pfizer_v_other_pfz", replace
