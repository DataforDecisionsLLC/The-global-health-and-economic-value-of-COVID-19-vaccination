...
/*
inputs: 
X_vax_pfz_upper.dta created in: make_X_vax_lower_upper.do
X_vax_pfz_lower.dta created in: make_X_vax_lower_upper.do
...
use "$root\REGRESSION RESULTS\SUR\LOWER UPPER INF\X_vax_pfz_`inf'", clear
...
compress
save "$root\REGRESSION RESULTS\SUR\LOWER UPPER INF\sim_0_beta_&_X_vax_pfz_`inf'", replace
