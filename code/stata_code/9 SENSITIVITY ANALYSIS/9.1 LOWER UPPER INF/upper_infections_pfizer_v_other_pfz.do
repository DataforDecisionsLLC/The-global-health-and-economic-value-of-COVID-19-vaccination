...
merge 1:1 country_group time using "$root\REGRESSION RESULTS\SUR\LOWER UPPER INF\sim_0_novax_inf_pfz_upper"
drop if _m==2
...
ren tot_gain averted_inf_pfz

save "$root\REGRESSION RESULTS\SUR\LOWER UPPER INF\upper_infections_pfizer_v_other_pfz", replace
