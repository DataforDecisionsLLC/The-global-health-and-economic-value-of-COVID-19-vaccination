...
merge 1:m country_group using "$root\REGRESSION RESULTS\SUR\LOWER UPPER INF\sim_0_novax_inf_pfz_lower"
drop if _m==2
drop _m 
qui tab country 
di `r(r)' 
...
save "$root\REGRESSION RESULTS\ANNUAL & QUARTERLY GDP\sim_0_novax_inf_pfz_quarterly_gdp_lower_pfz", replace
...
merge 1:1 country time using "$root\REGRESSION RESULTS\ANNUAL & QUARTERLY GDP\sim_0_novax_inf_pfz_quarterly_gdp_lower_pfz"
drop if _m==2
...
save "$root\REGRESSION RESULTS\SUR\LOWER UPPER INF\lower_gdp_pfizer_v_other_pfz", replace
