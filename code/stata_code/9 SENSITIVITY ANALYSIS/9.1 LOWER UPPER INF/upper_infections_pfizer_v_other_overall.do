...
merge 1:m country using "$root\REGRESSION RESULTS\SUR\LOWER UPPER INF\sur_regbase_infections_upper"
assert _m==3
drop _m
...
merge 1:1 country_group time using "$root\REGRESSION RESULTS\SUR\LOWER UPPER INF\sim_0_novax_inf_all_vax_upper"
drop if _m==2
...
ren tot_gain averted_inf_overall

save "$root\REGRESSION RESULTS\SUR\LOWER UPPER INF\upper_infections_pfizer_v_other_overall", replace
