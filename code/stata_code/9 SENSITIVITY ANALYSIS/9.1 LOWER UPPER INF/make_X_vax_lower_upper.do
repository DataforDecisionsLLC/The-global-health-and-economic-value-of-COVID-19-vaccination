...
sort variable time 
compress
save "$root\REGRESSION RESULTS\SUR\LOWER UPPER INF\X_vax_`inf'.dta",replace

end

getshell 135 lower
use "$root\REGRESSION RESULTS\SUR\LOWER UPPER INF\X_vax_lower.dta", clear
drop x_135
save "$root\REGRESSION RESULTS\SUR\LOWER UPPER INF\X_vax_lower.dta", replace

getshell 135 upper
use "$root\REGRESSION RESULTS\SUR\LOWER UPPER INF\X_vax_upper.dta", clear
drop x_135
save "$root\REGRESSION RESULTS\SUR\LOWER UPPER INF\X_vax_upper.dta", replace
...
merge 1:1 variable time using "$root\REGRESSION RESULTS\SUR\LOWER UPPER INF\X_vax_`inf'"
assert _m!=1
...
compress
save "$root\REGRESSION RESULTS\SUR\LOWER UPPER INF\X_vax_`inf'",replace
