...
use                                          "$root\REGRESSION RESULTS\SUR\LOWER UPPER INF\upper_death_pfizer_v_other_overall", clear 
merge 1:1 country year quarter yyyy_qq using "$root\REGRESSION RESULTS\SUR\LOWER UPPER INF\upper_infections_pfizer_v_other_overall"
assert _m==3 
drop _m 
...
compress 
save "$root\REGRESSION RESULTS\SUR\LOWER UPPER INF\value_of_vax_costs_upper", replace

////////////////////////////////////////////////////////////////////////////////
//////////// compute Pfizer's averted fatal and non-fatal cases ////////////////
////////////////////////////////////////////////////////////////////////////////

use                                          "$root\REGRESSION RESULTS\SUR\LOWER UPPER INF\upper_death_pfizer_v_other_pfz", clear 
merge 1:1 country year quarter yyyy_qq using "$root\REGRESSION RESULTS\SUR\LOWER UPPER INF\upper_infections_pfizer_v_other_pfz"
assert _m==3 
drop _m 
...
append using  "$root\REGRESSION RESULTS\SUR\LOWER UPPER INF\value_of_vax_costs_upper"
...
use "$root\REGRESSION RESULTS\SUR\LOWER UPPER INF\upper_gdp_pfizer_v_other_overall", clear
keep country yyyy_qq year quarter gdpdiff0
ren gdpdiff0 gdp_gain_overall_qrtly
gen brand = "Overall"
order brand

append using "$root\REGRESSION RESULTS\SUR\LOWER UPPER INF\upper_gdp_pfizer_v_other_pfz", keep(country yyyy_qq year quarter gdpdiff0)
sort country year quarter 
ren gdpdiff0 gdp_gain_pfz_qrtly
replace brand = "Pfizer" if brand==""

compress 
save "$root\REGRESSION RESULTS\SUR\LOWER UPPER INF\upper_value_of_vax_gdp_qrtly", replace

use "$root\REGRESSION RESULTS\SUR\LOWER UPPER INF\upper_gdp_annual_overall"
keep country gdpdiff0 
gen brand = "Overall"
order brand
ren gdpdiff0 gdp_gain_overall_annual

append using "$root\REGRESSION RESULTS\SUR\LOWER UPPER INF\upper_gdp_annual_pfz", keep(country gdpdiff0)
replace brand = "Pfizer" if brand==""
ren gdpdiff0 gdp_gain_pfz_annual

compress 
save "$root\REGRESSION RESULTS\SUR\LOWER UPPER INF\upper_value_of_vax_gdp_annual", replace

use "$root\REGRESSION RESULTS\SUR\LOWER UPPER INF\upper_value_of_vax_gdp_qrtly", clear

merge 1:1 country yyyy_qq year quarter brand using "$root\REGRESSION RESULTS\SUR\LOWER UPPER INF\value_of_vax_costs_upper"
assert _m!=1
drop _m 
...
merge 1:1 country brand using "$root\REGRESSION RESULTS\SUR\LOWER UPPER INF\upper_value_of_vax_gdp_annual"
