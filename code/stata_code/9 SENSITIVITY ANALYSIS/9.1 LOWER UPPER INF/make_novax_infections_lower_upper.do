...
use "$root\REGRESSION RESULTS\SUR\LOWER UPPER INF\sim_0_beta_&_X_vax_`inf'"
...
save "$root\REGRESSION RESULTS\SUR\LOWER UPPER INF\sim_0_beta_&_X_novax_`inf'", replace
...
use "$root\REGRESSION RESULTS\SUR\LOWER UPPER INF\sim_0_beta_&_X_novax_`inf'", clear
...
compress
save "$root\REGRESSION RESULTS\SUR\LOWER UPPER INF\\sim_`sim'_yhat_inc_novax_2020Q4_all_vax_`inf'", replace

/////////// step 2: predict infections in 2021 Q2 (t=11) under no vax //////////

use "$root\REGRESSION RESULTS\SUR\LOWER UPPER INF\sim_0_beta_&_X_novax_`inf'", clear
append using "$root\REGRESSION RESULTS\SUR\LOWER UPPER INF\sim_`sim'_yhat_inc_novax_2020Q4_all_vax_`inf'"
...
save "$root\REGRESSION RESULTS\SUR\LOWER UPPER INF\\sim_`sim'_novax_inf_2020Q4_all_vax_`inf'" , replace 
...
compress
save "$root\REGRESSION RESULTS\SUR\LOWER UPPER INF\sim_`sim'_yhat_inc_novax_2021Q1_all_vax_`inf'", replace

/////////// step 2: predict infections in 2021 Q3 (t=12) under no vax //////////
 
use "$root\REGRESSION RESULTS\SUR\LOWER UPPER INF\sim_0_beta_&_X_novax_`inf'", clear
append using "$root\REGRESSION RESULTS\SUR\LOWER UPPER INF\sim_`sim'_yhat_inc_novax_2021Q1_all_vax_`inf'"
...
save "$root\REGRESSION RESULTS\SUR\LOWER UPPER INF\sim_`sim'_novax_inf_2021Q1_all_vax_`inf'" , replace 
...
save "$root\REGRESSION RESULTS\SUR\LOWER UPPER INF\sim_`sim'_novax_inf_2021Q2_all_vax_`inf'" , replace 

////////////////////////////////////////////////////////////////////////////////
///////////////////////////// combine all countries ////////////////////////////
////////////////////////////////////////////////////////////////////////////////

use          "$root\REGRESSION RESULTS\SUR\LOWER UPPER INF\sim_`sim'_novax_inf_2020Q4_all_vax_`inf'" , clear 
merge 1:1 time variable using "$root\REGRESSION RESULTS\SUR\LOWER UPPER INF\sim_`sim'_novax_inf_2021Q1_all_vax_`inf'"
assert _m!=2 
drop _m 
sort time variable 
merge 1:1 time variable using "$root\REGRESSION RESULTS\SUR\LOWER UPPER INF\sim_`sim'_novax_inf_2021Q2_all_vax_`inf'"
assert _m!=2 
drop _m 
sort time variable 
isid time variable
...
save "$root\REGRESSION RESULTS\SUR\LOWER UPPER INF\sim_`sim'_novax_inf_all_vax_`inf'" , replace 
