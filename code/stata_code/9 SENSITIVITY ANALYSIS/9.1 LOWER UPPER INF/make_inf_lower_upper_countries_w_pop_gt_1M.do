...
capture log close
log using "$output\IHME\make_inf_lower_upper_countries_w_pop_gt_1M_countries_w_pop_gt_1M", text replace
...
collapse (sum) inf_cuml_lower inf_cuml_mean inf_cuml_upper inf_mean inf_lower inf_upper, by(date)
...
save "$output\IHME\infections_Hong_Kong_plus_Macoa", replace
...
order country date year quarter 

compress
save "$output\IHME\infections_countries_w_pop_gt_1M", replace

////////////////////////////////////////////////////////////////////////////////
///// subtract Hong Kong and Macao infections, deaths and vax from China ///////
////////////////////////////////////////////////////////////////////////////////

use "$output\IHME\infections_Hong_Kong_plus_Macoa" , clear 
append using "$output\IHME\infections_countries_w_pop_gt_1M"
isid country date
...
sort date country
foreach var in ///
inf_cuml_lower inf_cuml_mean inf_cuml_upper ///
inf_lower      inf_mean      inf_upper  {
...
compress 
save "$output\IHME\infections_China_minus_Hong_Kong_plus_Macoa", replace
...
append using "$output\IHME\infections_China_minus_Hong_Kong_plus_Macoa"
sort country date 
isid country date
