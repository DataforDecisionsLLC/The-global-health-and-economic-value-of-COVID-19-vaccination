...
X_novax_gdp_annual_pfz.dta created in: make_X_vax_X_novax_sims1000_gdp_annual.do 
vov_vars_gdp_annual.dta created in: sims1000_gdp_annual.do 
*/
...
gen rownum=_n 
drop X1
save "$root\REGRESSION RESULTS\SUR\SIMULATIONS\gains_gdp_annual_pfz.dta", replace

capture log close
log using "$root\REGRESSION RESULTS\SUR\SIMULATIONS\sims_1000_gdp_annual_pfz", text replace
...
use "$root\REGRESSION RESULTS\SUR\SIMULATIONS\X_novax_gdp_annual_pfz", clear
...
merge 1:1 rownum using "$root\REGRESSION RESULTS\SUR\SIMULATIONS\gains_gdp_annual_pfz.dta"
assert _m==3 
drop _m 
sort rownum
...
////////////////////////////////////////////////////////////////////////////////
////////////////////// 8. map on the 2019 per capital GDP //////////////////////
////////////////////////////////////////////////////////////////////////////////

use "$root\REGRESSION RESULTS\SUR\SIMULATIONS\gains_gdp_annual_pfz", clear 
...
save "$root\REGRESSION RESULTS\SUR\SIMULATIONS\gains_gdp_annual_w_vov_vars_pfz", replace

////////////////////////////////////////////////////////////////////////////////
///// 9. compute total averted gdp loss for each of the 1000 simulations ///////
////////////////////////////////////////////////////////////////////////////////

use   "$root\REGRESSION RESULTS\SUR\SIMULATIONS\gains_gdp_annual_w_vov_vars_pfz", clear
...
save "$root\REGRESSION RESULTS\SUR\SIMULATIONS\gains_gdp_annual_long_pfz", replace
...
save "$root\REGRESSION RESULTS\SUR\SIMULATIONS\gdp_annual_vov_sureg_pfz", replace

egen VoV_gdp_annual=rowtotal(gain_gdp_1 - gain_gdp_66)
drop gain_gdp_*

save "$root\REGRESSION RESULTS\SUR\SIMULATIONS\VoV_gdp_annual_pfz", replace
