...
capture log close
log using "$root\REGRESSION RESULTS\ANNUAL & QUARTERLY GDP\quarterly_regs_pfz", text replace

////////////////////////////////////////////////////////////////////////////////
////////////////// get the no pfizer natural immunity file /////////////////////
////////////////////////////////////////////////////////////////////////////////
...
merge 1:m country_group using "$root\REGRESSION RESULTS\SUR\SIMULATIONS\sim_0_novax_inf_pfz_deaths_inf"
drop if _m==2
drop _m 
drop country_group 
sort country time
...
save "$root\REGRESSION RESULTS\ANNUAL & QUARTERLY GDP\sim_0_novax_inf_pfz_quarterly_gdp", replace

////////////////////////////////////////////////////////////////////////////////
//////////////// no contemporaneous with 2 lags; drop 2022 /////////////////////
////////////////////////////////////////////////////////////////////////////////
...
merge 1:1 country time using "$root\REGRESSION RESULTS\ANNUAL & QUARTERLY GDP\sim_0_novax_inf_pfz_quarterly_gdp"
drop if _m==2
