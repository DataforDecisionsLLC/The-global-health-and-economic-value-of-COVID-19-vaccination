...
capture log close
log using "$root\REGRESSION RESULTS\SUR\SIMULATIONS\make_X_vax_X_novax_pfz", text replace
...
save "$root\REGRESSION RESULTS\SUR\SIMULATIONS\sim_`sim'_X_novax_sureg_pfz", replace
