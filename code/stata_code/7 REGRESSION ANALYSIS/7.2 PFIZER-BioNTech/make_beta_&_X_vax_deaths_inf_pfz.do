...
/*
inputs: 
X_vax_deaths_inf_pfz.dta created in: make_X_vax_deaths_inf_pfz.do 
...
capture log close
log using "$root\REGRESSION RESULTS\SUR\SIMULATIONS\make_beta_&_X_vax_deaths_inf_pfz", text replace

////////////////////////////////////////////////////////////////////////////////
/////////////////////////////// combine betas & Xs /////////////////////////////
////////////////////////////////////////////////////////////////////////////////

use "$root\REGRESSION RESULTS\SUR\X_vax_deaths_inf_pfz", clear
...
compress
save "$root\REGRESSION RESULTS\SUR\SIMULATIONS\sim_0_beta_&_X_vax_deaths_inf_pfz", replace
