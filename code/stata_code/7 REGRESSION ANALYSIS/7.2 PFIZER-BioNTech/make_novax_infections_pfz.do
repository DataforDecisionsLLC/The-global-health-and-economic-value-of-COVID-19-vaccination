...
/*
inputs:
sim_`sim'_beta_&_X_vax_pfz.dta created in: make_beta_&_X_vax_pfz.do 
*/

capture log close
log using "$root\REGRESSION RESULTS\SUR\\make_novax_infections_pfz", text replace
...
use "$root\REGRESSION RESULTS\SUR\SIMULATIONS\sim_`sim'_beta_&_X_vax_pfz", clear
...
save "$root\REGRESSION RESULTS\SUR\SIMULATIONS\sim_`sim'_beta_&_X_novax_pfz", replace
...
use "$root\REGRESSION RESULTS\SUR\SIMULATIONS\sim_`sim'_beta_&_X_novax_pfz", clear
...
compress
save "$root\REGRESSION RESULTS\SUR\SIMULATIONS\sim_`sim'_yhat_inc_novax_2020Q4_pfz", replace

/////////// step 2: predict infections in 2021 Q2 (t=11) under no vax //////////

use "$root\REGRESSION RESULTS\SUR\SIMULATIONS\sim_`sim'_beta_&_X_novax_pfz", clear
append using "$root\REGRESSION RESULTS\SUR\SIMULATIONS\sim_`sim'_yhat_inc_novax_2020Q4_pfz"
...
save "$root\REGRESSION RESULTS\SUR\SIMULATIONS\sim_`sim'_novax_inf_2020Q4_pfz" , replace 
...
compress
save "$root\REGRESSION RESULTS\SUR\SIMULATIONS\sim_`sim'_yhat_inc_novax_2021Q1_pfz", replace

/////////// step 2: predict infections in 2021 Q3 (t=12) under no vax //////////
 
use "$root\REGRESSION RESULTS\SUR\SIMULATIONS\sim_`sim'_beta_&_X_novax_pfz", clear
append using "$root\REGRESSION RESULTS\SUR\SIMULATIONS\sim_`sim'_yhat_inc_novax_2021Q1_pfz"
...
save "$root\REGRESSION RESULTS\SUR\SIMULATIONS\sim_`sim'_novax_inf_2021Q1_pfz" , replace 
...
save "$root\REGRESSION RESULTS\SUR\SIMULATIONS\sim_`sim'_novax_inf_2021Q2_pfz" , replace 

////////////////////////////////////////////////////////////////////////////////
///////////////////////////// combine all countries ////////////////////////////
////////////////////////////////////////////////////////////////////////////////

use          "$root\REGRESSION RESULTS\SUR\SIMULATIONS\sim_`sim'_novax_inf_2020Q4_pfz" , clear 
merge 1:1 time variable using "$root\REGRESSION RESULTS\SUR\SIMULATIONS\sim_`sim'_novax_inf_2021Q1_pfz"
assert _m!=2 
drop _m 
sort time variable 
merge 1:1 time variable using "$root\REGRESSION RESULTS\SUR\SIMULATIONS\sim_`sim'_novax_inf_2021Q2_pfz"
assert _m!=2 
drop _m 
sort time variable 
isid time variable
...
save "$root\REGRESSION RESULTS\SUR\SIMULATIONS\sim_`sim'_novax_inf_pfz" , replace 
