...
3. sim_0_novax_inf_pfz_deaths_inf.dta created in: make_novax_infections_pfz.do
*/

capture log close
log using "$root\REGRESSION RESULTS\SUR\no_cont_2_lags_infections_pfizer_v_other_pfz", text replace
...
save "$root\REGRESSION RESULTS\SUR\no_cont_2_lags_infections_pfizer_v_other_pfz", replace
