...
sim_0_beta_&_X_vax_deaths_inf_pfz.dta created in make_beta_&_X_vax_deaths_inf_pfz.do 
output:
sim_0_novax_inf_pfz_deaths_inf.dta
*/

capture log close
log using "$root\REGRESSION RESULTS\SUR\SIMULATIONS\make_novax_infections_deaths_inf_pfz", text replace
...
save "$root\REGRESSION RESULTS\SUR\pfz_launch_2020_Q4_deaths_inf", replace
...
save "$root\REGRESSION RESULTS\SUR\pfz_launch_2021_Q1_deaths_inf", replace
...
save "$root\REGRESSION RESULTS\SUR\pfz_launch_2021_Q2_deaths_inf", replace

////////////////////////////////////////////////////////////////////////////////
//////////////// set the Pfizer dose variables to zero /////////////////////////
////////////////////////////////////////////////////////////////////////////////

use "$root\REGRESSION RESULTS\SUR\SIMULATIONS\sim_0_beta_&_X_vax_deaths_inf_pfz", clear
...
save "$root\REGRESSION RESULTS\SUR\SIMULATIONS\sim_0_beta_&_X_novax_deaths_inf_pfz", replace
...
use "$root\REGRESSION RESULTS\SUR\SIMULATIONS\sim_`sim'_beta_&_X_novax_deaths_inf_pfz", clear
...
compress
save "$root\REGRESSION RESULTS\SUR\SIMULATIONS\sim_`sim'_yhat_inc_novax_2020Q4_deaths_inf_pfz", replace

/////////// step 2: predict infections in 2021 Q2 (t=11) under no vax //////////

use "$root\REGRESSION RESULTS\SUR\SIMULATIONS\sim_`sim'_beta_&_X_novax_deaths_inf_pfz", clear
append using "$root\REGRESSION RESULTS\SUR\SIMULATIONS\sim_`sim'_yhat_inc_novax_2020Q4_deaths_inf_pfz"
...
save "$root\REGRESSION RESULTS\SUR\SIMULATIONS\sim_`sim'_novax_inf_2020Q4_deaths_inf_pfz" , replace 
...
compress
save "$root\REGRESSION RESULTS\SUR\SIMULATIONS\sim_`sim'_yhat_inc_novax_2021Q1_deaths_inf_pfz", replace

/////////// step 2: predict infections in 2021 Q3 (t=12) under no vax //////////
 
use "$root\REGRESSION RESULTS\SUR\SIMULATIONS\sim_`sim'_beta_&_X_novax_deaths_inf_pfz", clear
append using "$root\REGRESSION RESULTS\SUR\SIMULATIONS\sim_`sim'_yhat_inc_novax_2021Q1_deaths_inf_pfz"
...
save "$root\REGRESSION RESULTS\SUR\SIMULATIONS\sim_`sim'_novax_inf_2021Q1_deaths_inf_pfz" , replace 
...
save "$root\REGRESSION RESULTS\SUR\SIMULATIONS\sim_`sim'_novax_inf_2021Q2_deaths_inf_pfz" , replace 

////////////////////////////////////////////////////////////////////////////////
///////////////////////////// combine all countries ////////////////////////////
////////////////////////////////////////////////////////////////////////////////

use          "$root\REGRESSION RESULTS\SUR\SIMULATIONS\sim_`sim'_novax_inf_2020Q4_deaths_inf_pfz" , clear 
merge 1:1 time variable using "$root\REGRESSION RESULTS\SUR\SIMULATIONS\sim_`sim'_novax_inf_2021Q1_deaths_inf_pfz"
assert _m!=2 
drop _m 
sort time variable 
merge 1:1 time variable using "$root\REGRESSION RESULTS\SUR\SIMULATIONS\sim_`sim'_novax_inf_2021Q2_deaths_inf_pfz"
assert _m!=2 
drop _m 
sort time variable 
isid time variable
...
save "$root\REGRESSION RESULTS\SUR\SIMULATIONS\sim_`sim'_novax_inf_pfz_deaths_inf" , replace 
