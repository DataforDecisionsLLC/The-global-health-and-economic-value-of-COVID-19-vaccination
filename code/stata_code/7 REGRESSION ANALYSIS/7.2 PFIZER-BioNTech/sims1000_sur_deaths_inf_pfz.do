...
sim_`sim'_X_novax_sureg_pfz.dta created in: make_X_vax_X_novax_pfz.do
vov_vars_sureg_deaths_inf.dta created in: make_vov_vars_sureg_deaths_inf.do
VoV_gdp_qrtly_pfz.dta created in: sims1000_gdp_qrtly_pfz.do
VoV_gdp_annual_pfz.dta created in: sims1000_gdp_annual_pfz.do 
*/

////////////////////////////////////////////////////////////////////////////////
//// 1. make the 1000 x 159 matrix that stacks the 155 coefficient estimates ///
...
keep rownum
save "$root\REGRESSION RESULTS\SUR\SIMULATIONS\gains_sureg_pfz.dta", replace

capture log close
log using "$root\REGRESSION RESULTS\SUR\SIMULATIONS\sims_1000_sur_deaths_inf_pfz", text replace
...
use "$root\REGRESSION RESULTS\SUR\SIMULATIONS\sim_`sim'_X_novax_sureg_pfz", clear
...
// the matrix G_death has 1160 (country-quarters) x 1 gains in averted deaths for each simulation
...
merge 1:1 rownum using "$root\REGRESSION RESULTS\SUR\SIMULATIONS\gains_sureg_pfz"
assert _m==3 
drop _m 
sort rownum

save "$root\REGRESSION RESULTS\SUR\SIMULATIONS\gains_sureg_pfz", replace
...
use "$root\REGRESSION RESULTS\SUR\SIMULATIONS\gains_sureg_pfz", clear 
...
save "$root\REGRESSION RESULTS\SUR\SIMULATIONS\gains_sureg_w_vov_vars_pfz", replace

////////////////////////////////////////////////////////////////////////////////
//////////// 9. compute population-wide averted deaths, infections /////////////
//// & non-fatal infections from pfizer for each of the 1000 simulations ///////
////////////////////////////////////////////////////////////////////////////////

use   "$root\REGRESSION RESULTS\SUR\SIMULATIONS\gains_sureg_w_vov_vars_pfz", clear
...
////////////////////////////////////////////////////////////////////////////////
///// 10. compute total averted gdp loss for each of the 1000 simulations //////
////////////////////////////////////////////////////////////////////////////////
...
save "$root\REGRESSION RESULTS\SUR\SIMULATIONS\gains_sureg_long_pfz", replace
...
use "$root\REGRESSION RESULTS\SUR\SIMULATIONS\gains_sureg_long_pfz", clear
...
////////////////////////////////////////////////////////////////////////////////
//////////////// 12. for each simulation/country-quarter ///////////////////////
...
////////////////////////////////////////////////////////////////////////////////
////////// 13. monetize health gains using pre-pandemic 2019 full income ///////
////////////////////////////////////////////////////////////////////////////////

gen vov_overall = qaly_gain_overall*yf
drop yf

keep sim rownum vov_overall averted_cost_overall /*gain_gdp*/
...
save "$root\REGRESSION RESULTS\SUR\SIMULATIONS\sim1000_vov_sureg_pfz", replace

////////////////////////////////////////////////////////////////////////////////
/////// 14. compute the VoV of all brands for each of the 1000 simulations /////
////////////////////////////////////////////////////////////////////////////////

use "$root\REGRESSION RESULTS\SUR\SIMULATIONS\sim1000_vov_sureg_pfz", clear
...
save "$root\REGRESSION RESULTS\SUR\SIMULATIONS\VoV_sureg_pfz" , replace

///////////////// combine with gdp /////////////////////////////////////////////

use "$root\REGRESSION RESULTS\SUR\SIMULATIONS\VoV_sureg_pfz", clear

merge 1:1 sim using "$root\REGRESSION RESULTS\SUR\SIMULATIONS\VoV_gdp_qrtly_pfz"
assert _m==3 
drop _m 
merge 1:1 sim using "$root\REGRESSION RESULTS\SUR\SIMULATIONS\VoV_gdp_annual_pfz"
assert _m==3 
drop _m 
...
////////////////////////////////////////////////////////////////////////////////
/////// 15. get 2.5th & 97.5th percentiles of VoV from all vax and Pfizer //////
////////////////////////////////////////////////////////////////////////////////
