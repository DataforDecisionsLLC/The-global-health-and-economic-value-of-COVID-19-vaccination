...
capture log close
log using "$root\REGRESSION RESULTS\ANNUAL & QUARTERLY GDP\annual_gdp_regs_pfz", text replace
...
save "$root\REGRESSION RESULTS\ANNUAL & QUARTERLY GDP\pfz_annual_gdp", replace
