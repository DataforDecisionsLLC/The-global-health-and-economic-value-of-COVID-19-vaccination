...
capture log close
log using "$root\REGRESSION RESULTS\SUR\SIMULATIONS\make_beta_&_X_vax_sims1000", text replace

////////////////////////////////////////////////////////////////////////////////
/////////////////////////////// get the country betas //////////////////////////
////////////////////////////////////////////////////////////////////////////////

use variable beta_* country_group using "$root\REGRESSION RESULTS\SUR\SIMULATIONS\infections_betas_sims1000", clear
keep if regexm(variable,"^country_")
keep country_group beta_* 
sort country_group
order country_group	
xpose, clear
forvalues c=1/144 {
	local var = v`c'[1]
	ren v`c' country_`var'
}
drop in 1
gen sim=_n
...
order sim variable
compress
save "$root\REGRESSION RESULTS\SUR\SIMULATIONS\country_betas_sims1000" , replace
...
compress
save "$root\REGRESSION RESULTS\SUR\SIMULATIONS\sim_`sim'_beta_&_X_vax", replace
