...
sim_0_beta_&_X_vax_deaths_inf.dta created in: make_beta_&_X_vax_deaths_inf.do 
output:
sim_`sim'_novax_inf_all_vax_deaths_inf.dta
*/

capture log close
log using "$root\REGRESSION RESULTS\SUR\SIMULATIONS\make_novax_infections_deaths_inf", text replace

////////////////////////////////////////////////////////////////////////////////
///////////////////// group the countries by launch quarter ////////////////////
////////////////////////////////////////////////////////////////////////////////
...
forvalues v=1/`numvars' {
	ren v`v' novax_`=v`v'[1]'
}

save "$root\REGRESSION RESULTS\SUR\vax_launch_2020_Q4_deaths_inf", replace

use "$root\REGRESSION RESULTS\SUR\vax_launch_quarter_deaths_inf", clear
keep if launch_all==1
keep if yyyy_qq=="2021_Q1"
drop if country_group==.
keep country_group
xpose, clear
des, varlist
...
save "$root\REGRESSION RESULTS\SUR\vax_launch_2021_Q1_deaths_inf", replace

use "$root\REGRESSION RESULTS\SUR\vax_launch_quarter_deaths_inf", clear
keep if launch_all==1
keep if yyyy_qq=="2021_Q2"
drop if country_group==.
keep country_group
xpose, clear
des, varlist
...
save "$root\REGRESSION RESULTS\SUR\vax_launch_2021_Q2_deaths_inf", replace

////////////////////////////////////////////////////////////////////////////////
//////////////// set the vaccine dose variables to zero ////////////////////////
////////////////////////////////////////////////////////////////////////////////

use "$root\REGRESSION RESULTS\SUR\SIMULATIONS\sim_0_beta_&_X_vax_deaths_inf", clear
...
forvalues c = 1/145 {
	replace x_`c' = 0 if inlist(variable,"L1_uptake_pfizer","L2_cum_uptake_pfizer","L1_uptake_other","L2_cum_uptake_other")
}
...
save "$root\REGRESSION RESULTS\SUR\SIMULATIONS\sim_0_beta_&_X_novax_deaths_inf", replace
...
use "$root\REGRESSION RESULTS\SUR\SIMULATIONS\sim_`sim'_beta_&_X_novax_deaths_inf", clear
...
compress
save "$root\REGRESSION RESULTS\SUR\SIMULATIONS\sim_`sim'_yhat_inc_novax_2020Q4_all_vax_deaths_inf", replace

/////////// step 2: predict infections in 2021 Q2 (t=11) under no vax //////////

use "$root\REGRESSION RESULTS\SUR\SIMULATIONS\sim_`sim'_beta_&_X_novax_deaths_inf", clear
append using "$root\REGRESSION RESULTS\SUR\SIMULATIONS\sim_`sim'_yhat_inc_novax_2020Q4_all_vax_deaths_inf"
...
save "$root\REGRESSION RESULTS\SUR\SIMULATIONS\sim_`sim'_novax_inf_2020Q4_all_vax_deaths_inf" , replace 
...
compress
save "$root\REGRESSION RESULTS\SUR\SIMULATIONS\sim_`sim'_yhat_inc_novax_2021Q1_all_vax_deaths_inf", replace

/////////// step 2: predict infections in 2021 Q3 (t=12) under no vax //////////
 
use "$root\REGRESSION RESULTS\SUR\SIMULATIONS\sim_`sim'_beta_&_X_novax_deaths_inf", clear
append using "$root\REGRESSION RESULTS\SUR\SIMULATIONS\sim_`sim'_yhat_inc_novax_2021Q1_all_vax_deaths_inf"
...
save "$root\REGRESSION RESULTS\SUR\SIMULATIONS\sim_`sim'_novax_inf_2021Q1_all_vax_deaths_inf" , replace 
...
save "$root\REGRESSION RESULTS\SUR\SIMULATIONS\sim_`sim'_novax_inf_2021Q2_all_vax_deaths_inf" , replace 

////////////////////////////////////////////////////////////////////////////////
///////////////////////////// combine all countries ////////////////////////////
////////////////////////////////////////////////////////////////////////////////

use          "$root\REGRESSION RESULTS\SUR\SIMULATIONS\sim_`sim'_novax_inf_2020Q4_all_vax_deaths_inf" , clear 
merge 1:1 time variable using "$root\REGRESSION RESULTS\SUR\SIMULATIONS\sim_`sim'_novax_inf_2021Q1_all_vax_deaths_inf"
assert _m!=2 
drop _m 
sort time variable 
merge 1:1 time variable using "$root\REGRESSION RESULTS\SUR\SIMULATIONS\sim_`sim'_novax_inf_2021Q2_all_vax_deaths_inf"
assert _m!=2 
drop _m 
sort time variable 
isid time variable
...
save "$root\REGRESSION RESULTS\SUR\SIMULATIONS\sim_`sim'_novax_inf_all_vax_deaths_inf" , replace 
