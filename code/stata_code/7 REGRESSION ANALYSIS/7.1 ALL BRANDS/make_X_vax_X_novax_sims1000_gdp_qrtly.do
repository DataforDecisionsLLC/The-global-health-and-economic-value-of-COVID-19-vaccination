...
capture log close
log using "$root\REGRESSION RESULTS\SUR\SIMULATIONS\make_X_vax_X_novax_sims1000_gdp_qrtly", text replace
...
save "$root\REGRESSION RESULTS\SUR\SIMULATIONS\sim_`sim'_X_novax_gdp_qrtly", replace
...
save "$root\REGRESSION RESULTS\SUR\SIMULATIONS\X_vax_gdp_qrtly", replace
