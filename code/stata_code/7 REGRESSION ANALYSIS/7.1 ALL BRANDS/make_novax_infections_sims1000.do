...
/*
inputs: 
sim_`sim'_beta_&_X_vax.dta created in: make_beta_&_X_vax_sims1000.do
output:
sim_`sim'_novax_inf_all_vax.dta 
*/

capture log close
log using "$root\REGRESSION RESULTS\SUR\SIMULATIONS\make_novax_infections_sims1000", text replace

////////////////////////////////////////////////////////////////////////////////
//////////////// set the vaccine dose variables to zero ////////////////////////
////////////////////////////////////////////////////////////////////////////////

capture program drop novax 
program novax 
version 18.0 
set more off 
set type double 
...
use "$root\REGRESSION RESULTS\SUR\SIMULATIONS\sim_`sim'_beta_&_X_vax", clear

sort time sortme
// set vax to zero
order sim variable sortme time beta beta_1 beta_constant
...
save "$root\REGRESSION RESULTS\SUR\SIMULATIONS\sim_`sim'_beta_&_X_novax", replace
...
use "$root\REGRESSION RESULTS\SUR\SIMULATIONS\sim_`sim'_beta_&_X_novax", clear
...
compress
save "$root\REGRESSION RESULTS\SUR\SIMULATIONS\sim_`sim'_yhat_inc_novax_2020Q4_all_vax", replace

/////////// step 2: predict infections in 2021 Q2 (t=11) under no vax //////////

use "$root\REGRESSION RESULTS\SUR\SIMULATIONS\sim_`sim'_beta_&_X_novax", clear
append using "$root\REGRESSION RESULTS\SUR\SIMULATIONS\sim_`sim'_yhat_inc_novax_2020Q4_all_vax"
...
save "$root\REGRESSION RESULTS\SUR\SIMULATIONS\sim_`sim'_novax_inf_2020Q4_all_vax" , replace 
...
compress
save "$root\REGRESSION RESULTS\SUR\SIMULATIONS\sim_`sim'_yhat_inc_novax_2021Q1_all_vax", replace

/////////// step 2: predict infections in 2021 Q3 (t=12) under no vax //////////
 
use "$root\REGRESSION RESULTS\SUR\SIMULATIONS\sim_`sim'_beta_&_X_novax", clear
append using "$root\REGRESSION RESULTS\SUR\SIMULATIONS\sim_`sim'_yhat_inc_novax_2021Q1_all_vax"
...
save "$root\REGRESSION RESULTS\SUR\SIMULATIONS\sim_`sim'_novax_inf_2021Q1_all_vax" , replace 
...
save "$root\REGRESSION RESULTS\SUR\SIMULATIONS\sim_`sim'_novax_inf_2021Q2_all_vax" , replace 

////////////////////////////////////////////////////////////////////////////////
///////////////////////////// combine all countries ////////////////////////////
////////////////////////////////////////////////////////////////////////////////

use          "$root\REGRESSION RESULTS\SUR\SIMULATIONS\sim_`sim'_novax_inf_2020Q4_all_vax" , clear 
merge 1:1 time variable using "$root\REGRESSION RESULTS\SUR\SIMULATIONS\sim_`sim'_novax_inf_2021Q1_all_vax"
assert _m!=2 
drop _m 
sort time variable 
merge 1:1 time variable using "$root\REGRESSION RESULTS\SUR\SIMULATIONS\sim_`sim'_novax_inf_2021Q2_all_vax"
assert _m!=2 
drop _m 
sort time variable 
isid time variable
...
save "$root\REGRESSION RESULTS\SUR\SIMULATIONS\sim_`sim'_novax_inf_all_vax" , replace 
