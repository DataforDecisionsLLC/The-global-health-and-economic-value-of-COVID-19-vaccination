...
sim_`sim'_X_novax_gdp_qrtly.dta created in: make_X_vax_X_novax_sims1000_gdp_qrtly.do
...
gen rownum=_n 
drop X1
save "$root\REGRESSION RESULTS\SUR\SIMULATIONS\gains_gdp_qrtly.dta", replace

capture log close
log using "$root\REGRESSION RESULTS\SUR\SIMULATIONS\sims_1000_gdp_qrtly", text replace
...
use "$root\REGRESSION RESULTS\SUR\SIMULATIONS\sim_`sim'_X_novax_gdp_qrtly", clear

mkmat X1-X66, matrix(X_novax_gdp_qrtly)

////////////////////////////////////////////////////////////////////////////////
//////////////////// 5. compute the predicted values under novax ///////////////
...
merge 1:1 rownum using "$root\REGRESSION RESULTS\SUR\SIMULATIONS\gains_gdp_qrtly.dta"
assert _m==3 
drop _m 
sort rownum
...
////////////////////////////////////////////////////////////////////////////////
///////////////////// 8. map on the 2019 per capita gdp ////////////////////////
////////////////////////////////////////////////////////////////////////////////

use "$root\REGRESSION RESULTS\ANNUAL & QUARTERLY GDP\quarterly_gdp_regbase", clear 

drop if year<2020
merge 1:1 country year quarter using "$root\DATA\ECONOMIC DATA\quarterly_gdp_usd"
assert _m!=1 
keep if _m==3 
drop _m 
assert _N==408
...
save "$root\REGRESSION RESULTS\SUR\vov_vars_gdp_qrtly", replace

///////////////////////////////// all brands ///////////////////////////////////

use "$root\REGRESSION RESULTS\SUR\SIMULATIONS\gains_gdp_qrtly", clear 
...
save "$root\REGRESSION RESULTS\SUR\SIMULATIONS\gains_gdp_qrtly_w_vov_vars", replace

////////////////////////////////////////////////////////////////////////////////
///// 9. compute total averted gdp loss for each of the 1000 simulations ///////
////////////////////////////////////////////////////////////////////////////////

use   "$root\REGRESSION RESULTS\SUR\SIMULATIONS\gains_gdp_qrtly_w_vov_vars", clear
...
save "$root\REGRESSION RESULTS\SUR\SIMULATIONS\gains_gdp_qrtly_long", replace
...
save "$root\REGRESSION RESULTS\SUR\SIMULATIONS\gdp_qrtly_vov_sureg", replace

egen VoV_gdp_qrtly=rowtotal(gain_gdp_1 - gain_gdp_408)
drop gain_gdp_*

save "$root\REGRESSION RESULTS\SUR\SIMULATIONS\VoV_gdp_qrtly", replace
